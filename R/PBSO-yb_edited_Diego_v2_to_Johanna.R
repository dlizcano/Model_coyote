...
# sp_in_GBIF <- read.csv("data/PB_T_sernai_Depurado.csv")
...
## in this case mask and extent by Prec (mapa Angelica)              
########################################################
...
### cut Bioclim
bio_vars_crop <- crop(bio_vars, extent(Prec)) #crop
...
# read pb and PA survey data. This is the oportunistic data!
